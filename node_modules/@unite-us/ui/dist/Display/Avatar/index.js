  ...
  _createClass(Avatar, [{
    ...
    value: function render() {
      ...
      var _this$state = this.state,
          imageStatus = _this$state.imageStatus,
          hasFallback = _this$state.hasFallback;

      if (!shouldRender) {
        return null;
      }

      var avatarClass = function avatarClass() {
      ...
      }), fallbackIcon && !image && /*#__PURE__*/_react["default"].createElement(_Icon["default"], {
...
Avatar.propTypes = {
  ...
  fallbackIcon: _propTypes["default"].string
};
Avatar.defaultProps = {
  id: '',
  className: '',
