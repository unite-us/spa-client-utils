...
var TableRowColumn = /*#__PURE__*/function (_Component) {
  _inherits(TableRowColumn, _Component);

  var _super = _createSuper(TableRowColumn);
  ...
  _createClass(TableRowColumn, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          id = _this$props.id,
          isLockIcon = _this$props.isLockIcon,
      ...
      var tableRowColumnClass = function tableRowColumnClass() {
        return (0, _classnames["default"])({
          'ui-table-row-column': true,
          'ui-table-row-column--show-overflow': showOverflow,
          'ui-table-row-column--lock-icon': isLockIcon,
          'hidden-sm-down': _lodash["default"].includes(secondaryDataList, columnIndex)
        }, className);
      };

      var newChildren = (0, _filterChildren["default"])(this.props.children);
...
TableRowColumn.propTypes = {
  ...
  isLockIcon: _propTypes["default"].bool
};
